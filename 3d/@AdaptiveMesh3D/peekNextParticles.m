function [p, angularVelocity, rigidBodyPosition, inertia] = peekNextParticles(mesh, h, deltav)
    ...
    v = mesh.v;
    v(mesh.ActiveDofsCorrespondingID) = v(mesh.ActiveDofsCorrespondingID) + deltav(1:elasticN);
    p = mesh.p;
    p(mesh.ActiveDofsCorrespondingID) = mesh.p(mesh.ActiveDofsCorrespondingID) + h * v(mesh.ActiveDofsCorrespondingID); 
