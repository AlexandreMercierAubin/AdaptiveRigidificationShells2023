classdef Simulation3DSettings < handle
    ...
    properties
        ...
        DrawVertexNumbers = []; % draws spheres around the listed vertices
        DrawRigidFrames = 0;
        DrawForces = 0;
        DrawVelocities = 0;
        ...
        addShellNormalDeformation = false;
        addBendingEnergy = 0;
        useGrinspunPlanarEnergy = false;
