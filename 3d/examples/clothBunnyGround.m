...
alpha1 = 0.02;  % Rayleigh factor on K
thickness = 0.015;
strainUpperBound = 1.3;
strainLowerBound = 0.7;
ka = 0.1;
kl = 0.25;
tMaterial = [TriangleMaterial(rho, mu, lambda, alpha0, alpha1, [0.3,0.46,0.8],strainUpperBound,strainLowerBound,thickness,kl,ka,0.01)];
