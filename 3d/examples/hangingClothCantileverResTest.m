%The difference between 1 and 2 is that this one is not necessarily
%aligning edges with the bending
clear;
cla;
clear mesha;
h = 0.01; % time step
...
rigidificator.recordCurvatures = true;
...
rigidificator2.recordCurvatures = true;
...
rigidificator3.recordCurvatures = true;
...
settings.SceneName = 'clothResTest';
settings.OBJDir = './objs/clothResTestElastic/';
...
settings.plotCurvatureComparison = true;
