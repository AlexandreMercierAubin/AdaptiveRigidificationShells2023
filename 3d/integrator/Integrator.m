classdef Integrator < handle & matlab.mixin.Copyable
    properties
        Gravity
        InfMassForPinned
        Name
    ...
    methods (Abstract = true)
        integrate( obj, meshes, h, Jc, phi, cInfo, settings, cache, td, animationScripts, frame , energyModel, collisionDectectors);
