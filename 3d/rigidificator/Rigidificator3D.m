classdef Rigidificator3D < handle
    ...
    properties
       ...
       FrameCount
       Preconditionner = 'ICHOLICT'; %choices; chol, icholict, or ichol
       Permutation = 'DISSECT';
    ...
    methods
        ...
        function updateRigidBodies(obj, mesh, rigidTris, settings)
            ...
            if len > 0
                ...
                [mesh.RigidBodies(1:l).VertexIDs] = vertices{1:l}; 
            ...
            function body = makeBody(VertexIDs)
                body = RigidBody3D(mesh);
                body.VertexIDs = VertexIDs;
            end
        end
