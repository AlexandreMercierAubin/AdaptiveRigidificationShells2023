...
if ( settings.PlotEDotHist || settings.PlotDihedralRateHist || settings.PlotEdotVsCurvatureHists || settings.PlotEigs)
...
elseif settings.plotCurvatureComparison
    ax6 = axes( 'Position', [ 0.05 0.70 0.25 0.25 ] );
    disableDefaultInteractivity(ax6);
    axes(ax1);
    ax7 = axes( 'Position', [ 0.35 0.70 0.25 0.25 ] );
    disableDefaultInteractivity(ax7);
    axes(ax1);
    ax8 = axes( 'Position', [ 0.65 0.70 0.25 0.25 ] );
    disableDefaultInteractivity(ax8);
    axes(ax1);
    axesList=[axesList,ax6,ax7,ax8];
