classdef QuickSolveCache3D < handle
    ...
    properties
        ...
        shellBendingDampingH %damping matrix for shells bending energies
        grinspunPlanarH
        grinspunPlanarHd
        grinspunPlanarForces
        Kd
        K
        D
        bendingForces     % bending energy forces of shell
        NormalShellComponent %change in normals for shells
        dihedralAngle      %caching for efficient reuse of the angle
        dihedralApproxRate %for TriMesh3D, bending rate from quicksolve
        bendingRate       %for TriMesh3D, bending rate
